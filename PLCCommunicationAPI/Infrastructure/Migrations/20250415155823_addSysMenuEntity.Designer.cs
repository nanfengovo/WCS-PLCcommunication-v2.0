...
namespace PLCCommunication_Infrastructure.Migrations
{
    ...
    [Migration("20250415155823_addSysMenuEntity")]
    partial class addSysMenuEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PLCCommunication_Model.Entities.SysMenu", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("T_SysMenu", (string)null);
            ...
            modelBuilder.Entity("PLCCommunication_Model.Entities.SysMenu", b =>
                {
                    b.HasOne("PLCCommunication_Model.Identity.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PLCCommunication_Model.Entities.SysMenu", null)
                        .WithMany("Children")
