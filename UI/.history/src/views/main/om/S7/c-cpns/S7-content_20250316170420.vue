    ...
    < !--添加 -->
        <el-dialog v - model="dialogOverflowVisible" title = "添加S7数据点运维" width = "500" draggable overflow >
            <el-form v - model="form" label - width="100px" >
                <el-form - item - item label = "配置名" >
                    <el-input v - model="form.proxyName" placeholder = "请输入配置名" />
                        </el-form-item>
                        < el - form - item el - form - item label = "ip" >
                            <el-input v - model="form.ip" placeholder = "请输入ip" />
                                </el-form-item>
                                < el - form - item el - form - item label = "端口" >
                                    <el-input v - model="form.port" placeholder = "请输入端口" />
                                        </el-form-item>
                                        < el - form - item el - form - item label = "DB块id" >
                                            <el-input v - model="form.dbid" placeholder = "请输入DB块id" />
                                                </el-form-item>
                                                < el - form - item el - form - item label = "地址偏移" >
                                                                                                ...
                                                                                                < template #footer >
                                                                                                    <div class="dialog-footer" >
                                                                                                        <el-button @click="dialogOverflowVisible = false" > 重置 </el-button>
                                                                                                            < el - button el - button type = "primary" @click="dialogOverflowVisible = false" >
                                                                                                                添加
                                                                                                                </el-button>
                                                                                                                </div>
                                                                                                                </template>
