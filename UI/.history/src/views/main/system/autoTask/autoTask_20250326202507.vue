<template>
    <div class="S7autoTask">
        <div class="S7autoTask-content" v-if="isMounted">
            <H2>S7数据点定时任务(使用BackgroundService)</H2>
        ...
        <div class="ModbusTCPautoTask">
            <div class="ModbusTCPautoTask-content" v-if="isMounted">
                ...
                <div class="content-top">
                    ...
                    <div class="content-top-right">
                        <!-- 上传组件 -->
                        <el-upload ref="uploadRef" class="upload-demo" :action="uploadUrl" :auto-upload="true"
                            :limit="1" :before-upload="beforeUpload" :on-success="handleSuccess" :on-error="handleError"
                            :headers="headers" accept=".xlsx,.xls">
                            <template #trigger>
                ...
                <div class="content">
                    <el-scrollbar max-height="200px">
                        <el-table border style="width: 100%" :data="currentPageData" ref="multipleTableRef"
                            ...
                            <el-table-column align="center" prop="result" label="任务详情" width="200px"
